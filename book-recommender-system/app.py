...
popular_df['avg_rating_rounded'] = popular_df['avg_rating'].round(2)
...
def index():
    return render_template('index.html',
                           ...
                           rating=popular_df['avg_rating_rounded'].to_list(),
                           )
@app.route('/recommend')
def recommend_ui():
...
def recommend():
    ...
    if user_input not in pt.index:
        return render_template('fallback.html', message='Book not found. Please try a different book.')
